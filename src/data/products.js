...
export const products = [
  {
    ...
    price: 50,
    currency: 'TND',
    image: '/img/shop/tee-front.png',
    gallery: ['/img/shop/tee-front.png', '/img/shop/tee-back.png'],
    featured: true,
    delivery: 10,
    details: {
  ...
  },
  {
    ...
    price: 40,
    currency: 'TND',
    image: '/img/shop/tee-sticker.png',
    featured: true,
    delivery: 10,
    details: {
  ...
  },
  {
    ...
    price: 55,
    currency: 'TND',
    image: '/img/shop/combo-sticker.png',
    delivery: 10,
    details: {
